...
struct Material
{
    ...
    Material(sf::Vector3f albedoColor = sf::Vector3f(0, 0, 0), float roughness = 1, sf::Vector3f metalnessColor = sf::Vector3f(0, 0, 0), float metalness = 0, sf::Vector3f emissionColor = sf::Vector3f(0, 0, 0), float emissionStrength = 0, sf::Vector3f fresnelColor = sf::Vector3f(0, 0, 0), float fresnelStrength = 0, float refractionFactor = 0, float density = 0);
