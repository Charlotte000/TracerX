...
If the __TX_SPIRV__ option is disabled, the shaders will be included in the executable file. In this case, you need to rebuild the project to see the changes the same way as in the __SPIR-V__ case.
